    ...
    <body>
        <div class="basic">
            ...
            <p>
                ...
                прописывал в hibernate.cfg.xml. Хотя, крайне возможно, я просто чего-то не понимаю: почему-то
                иногда объем используемой памяти Томката (смотрю через диспетчер задач в Windows) сильно снижается.
            </p>
            <p>
